...
#ifndef PROXY_HTTP_REQUEST_PARSER_H
#define PROXY_HTTP_REQUEST_PARSER_H
...
public:
    ...
    http_request_parser(const char* request) {
        ...
        try {
            ...
            std::stringstream(major_version)>>this->major_version;
            std::stringstream(minor_version)>>this->minor_version;
...
#endif //PROXY_HTTP_REQUEST_PARSER_H
